...
//			, "fnt_qck_020101_1.html"         //간편송금서비스 > 간편송금
		...
		preapreSvcDiv : function($jq) {
			...
			//SCIB 1등급 터치 펀드 추가매입 적정여부 조회
			var trnform_fnc_fnm_010301_0 = '<div id="trnform_fnc_fnm_010301_0" '
				+ 'data-jx-svc="fnc_fnm_010301_0" '
				+ 'data-jx-svc-package="fnc_fnm" '
				+ 'data-jx-svc-target="@_tran_res_data[0]" '
				+ 'data-jx-svc-handler-in="trnform_fnc_fnm_010301_0.uf_in()" '
				+ 'data-jx-svc-handler-out="trnform_fnc_fnm_010301_0.uf_out()" '
				+ 'data-jx-svc-execute="FUNC@trnform_fnc_fnm_010301_0.uf_exec()" style="display:none"></div>';
			$('body').append(trnform_fnc_fnm_010301_0);
		...
		preparePopup : function($jq) {
			...
			var mmtAcntDetailPopupHtml = ""
				...
				+ '							</span>'
				+ '							<span class="line_right">'
				+ '								<span class="rate"><span id="TRST_RMNR_RT"></span>%</span>'
				+ '							</span>'
				+ '						</p>'
				+ '						<p class="line" role="text">'
				+ '							<span class="line_left">'
				...
				+ '							</span>'
				+ '							<span class="line_right">'
				+ '								<span class="rate"><span id="MNIE_RT"></span>%</span>'
				+ '							</span>'
				+ '						</p>'
				+ '						<p class="line" role="text">'
				+ '							<span class="line_left">'
			...
			var bankListPopupHtml = ""
				+'<div id="bankListStep" class="bottom_popup_wrap">'
			...
			var bankListOpenPopupHtml = ""
				+'<div id="bankListOpenStep" class="bottom_popup_wrap">'
					+ '<div class="bottom_popup">'
						+ '<div class="bottom_popup_header">'
							+ '<h2 class="tit">기관 선택</h2>'
		...
		drawFavTrnButtonHtml : function($jq) {
			...
			//[자주쓰는이체](즉시이체 등)
			favTrnStepHtml.find("#trnform_search_btn").off().on('click', function(evt) { //검색 Click Event
		...
		drawDrocAcntAreaHtml : function($jq) {
			...
			if("fnt_trn_110101_1" == window._tranForm.drotAcntViewType) {	
				...
				+ '<div class="bottom_popup">'
					...
					+ '<div class="bottom_popup_body tab_in">'
						+ '<div id="tab_list" class="tab_list ty1" role="tablist" style="display:none">'
						...
						+ '<div id="tab_cont" class="tab_cont active" role="tabpanel" aria-expanded="true">'
							+ '<ul class="select_list ty3 mt_24" role="listbox" id="' + this.formIds.acntListTbl + '" data-jx-list="' + this.formIds.acntListTbl + '">'
								...
								+ 'data-jx-setter-execute="">'
										+ '<div class="item">'
											+ '<div class="item_top">'
												+ '<span id="indv_ico"></span>'
												+ '<div class="item_top_text" id="ACNT_NM"></div>'
											+ '</div>'
											+ '<div class="acount_item ty5">'
												+ '<div class="ico_box ty5 ico_bank_003"></div>'
												+ '<div class="item">'
													+ '<div class="item_top">'
													+ '<span class="bank_name">기업</span>'
													+ '<span class="ac_num" id="EBNK_ACN" data-jx-formatter="account"></span>'
												+ '</div>'
											+ '</div>'
										+ '</div>'
								+ '</li>'
							...
							+ '<ul class="select_list ty3 mt_24" role="listbox" id="' + this.formIds.myOpnDrotAcntListTbl + '" data-jx-list="' + this.formIds.myOpnDrotAcntListTbl + '">'
								...
								+ 'data-jx-setter-execute="">'
									+ '<div class="item">'
										...
										+ '</div>'
										+ '<div class="acount_item ty5">'
											+ '<div id="open_logo" class="ico_box ty5 ico_bank_000"></div>'
											+ '<div class="item">'
												+ '<div class="item_top"><span id="BANK_NM"></span><span id="RGSN_ACN"></span></div>'
											+ '</div>'
										+ '</div>'
										+ '<div class="item_top skeleton">'
									...
									+ 'data-jx-setter-execute="" class="account_list_item" role="option" tabindex="-1" aria-selected="false">'
										+ '<div class="item">'
											...
											+ '<div class="item_bottom">'
												...
												+ '<div class="item_bottom_text">기업 <span id="EBNK_ACN" data-jx-formatter="account"></span></div>'
												+ '<input id="EFNC_BNCD" type="hidden" value="003">'
												+ '<input id="ECFN_BNNM" type="hidden" value="기업은행">'
											+ '</div>'
										+ '</div>'
									+ '</li>'
									+ '<li id="EMPTY"><div class="no_result_msg"><div class="msg">출금계좌가 없습니다.</div></div></li>'
								+ '</ul>'
							+ '</div>'
						+ '</div>'
				+ '</div>';
				...
				acntAreaHtml = ""
					+ '<div id="' + this.formIds.drotAcntInfoId + '" class="acount_item_select ty1">'
						+ '<div id="trnform_area_drot" class="acount_item ty3" role="button" title="계좌선택 목록보기">'
							+ '<div class="badge_cont">'
								+ '<span id="indv_ico" style="display:none;"></span>'
								+ '<span class="txt_style ty6 fw_4" id="ACNT_NM"></span>'
							+ '</div>'
							+ '<div class="acount_item ty5">'
								+ '<div id="drot_bncd_logo"></div>'
								+ '<div class="item">'
									+ '<div class="item_top">'
										+ '<span class="bank_name" id="EBNK_NM"></span>'
										+ '<span class="ac_num"  id="EBNK_ACN" data-jx-formatter="account"></span>'
									+ '</div>'
						...
						+ '<div id="trnform_area_drot" class="acount_item ty3" role="button" title="계좌선택 목록보기">'
							...
							+ '<div class="acount_item ty5">'
								...
								+ '<div class="item">'
									+ '<div class="item_top">'
										+ '<span class="bank_name">기업 </span>'
										+ '<span  id="EBNK_ACN" data-jx-formatter="account"></span>'
									+ '</div>'
									+ '<input id="EBNK_CD" type="hidden" value="">'
				...
				acntAreaHtml = ""
					+ '<div id="' + this.formIds.drotAcntInfoId + '" >'
						+ '<div class="acount_item ty3" role="button" title="계좌선택 목록보기" id="trnform_area_drot">'
							+ '<div class="badge_cont" id="acnt_nm_dis_yn">'
								+ '<span id="indv_ico" style="display:none;"></span>'	
								+ '<span class="txt_style ty6 fw_4"><span id ="ACNT_NM"></span></span>'
							+ '</div>'
							+ '<div class="acount_item ty5">'
								...
								+ '<div class="item">'
									+ '<div class="item_top">'
										+ '<span class="bank_name">기업 </span>'
										+ '<span class="ac_num"><span id="EBNK_ACN" data-jx-formatter="account"></span></span>'
									+ '</div>'
								+ '</div>'
							+ '</div>'
						+ '</div>'
			...
			acntAreaHtml.find("#trnform_area_drot").off().on('click', function(evt) {   //출금계좌영역Click Event	
			...
			acntAreaHtml.find("#btn_trlm_view").off().on('click', function(evt) { 
...
//				+ '</div>';
		...
		latelyAcntStepHtml = '<div id="latelyAcntStep" class="bottom_popup_wrap" style="display:none;">'
					...
					+ '<div class="bottom_popup_body">'
						...
						+ '<ul class="space_list_ty5" id="' + this.formIds.latelyAcntListTbl + '" data-jx-list="' + this.formIds.latelyAcntListTbl + '">'
							+ '<li data-jx-execute="click" role="option" aria-selected="false" tabindex="-1"'
							+ 'data-jx-setter="" '
							+ 'data-jx-setter-source="this" '
			...
			latelyAcntStepHtml.find("#trnform_search_btn").off().on('click', function(evt) { //검색 Click Event
		...
		drawFavAcntButtonHtml : function($jq) {
			...
			//[자주쓰는계좌]
			favAcntStepHtml.find("#trnform_search_btn").off().on('click', function(evt) { //검색 Click Event
		...
		drawMyAcntButtonHtml : function($jq) {
			var myAcntStepHtml = ""
				+ '<div id="myAcntStep" class="bottom_popup_wrap">'
				+ '<div class="bottom_popup">'
					+ '<div class="bottom_popup_header">'
		...
		drawOptionAreaHtml : function($jq) {
			...
			if("fnt_trn_110101_1" == window._tranForm.optinViewType || "fnt_trn_030101_1" == window._tranForm.optinViewType || "fnt_trn_210101_1" == window._tranForm.optinViewType|| "fnt_trn_210201_1" == window._tranForm.optinViewType|| "fnt_vat_020101_1" == window._tranForm.optinViewType) {      //통합이체
			 ...
			 optionAreaHtml =""	
				 +'<div id = "trn_option_area">'
				 		+'<ul id="d_list" class="d_list ty3">'
							+'<li id="trn_opt_area_1" style="display:none;">'
								+'<span class="d_list_l">받는 분 통장 표기</span>'
								+'<span class="d_list_r">'
									+'<div class="input line_ty2 no_del">'
										+'<input type="text" name="" id="mnrc_smr_cntn" title="받는 분 통장 표기할 내용 입력" placeholder="출금계좌 실명" data-jx-chk="true" data-jx-chk-opt=\'{"name":"받는통장표시","nullable":false,"maxLength":10,"charType":"korEngNumSpec"}\'/>'
									+'</div>'
								+'</span>'
							+'</li>'
							+'<li id="trn_opt_area_2" style="display:none;">'
								...
								+'<span class="d_list_r">'
									+'<div class="input line_ty2 no_del">'
										+'<input type="text" name="" id="drot_smr_cntn"  title="미 입력시 받는 분 이름 입력" placeholder="내 통장 표기할 내용 입력" data-jx-chk="true" data-jx-chk-opt=\'{"name":"내통장표시","nullable":false,"maxLength":10,"charType":"korEngNumSpec"}\'/>'
									+'</div>'
								+'</span>'
							+'</li>'
								...
								+'<div class="inner">'
									+'<ul class="d_list ty3 bdt_none">'
										...
										+'<li id="trn_opt_area_4" style="display:none;">'
											...
											+'<span class="d_list_r">'
												+'<div id="fndsCodeSel" class="dropdown ty6" role="button" title="자금코드 선택 목록 보기">'
				...
				optionAreaHtml ="" 
					+'<div class="group" id="trn_opt_area" style="display:none;">'
						...
						+'<div class="form_group">'
							...
							+'<div class="input">'
								+'<input type="text" name="" id="drot_smr_cntn" title="출금계좌 표기 10자 이내 입력" placeholder="10자 이내 입력" data-jx-chk="true" data-jx-chk-opt=\'{"name":"내통장표시","nullable":false,"maxLength":10}\' />'
								+'<button type="button" class="del">텍스트삭제</button>'
							+'</div>'
							+'<div class="input_label ty2">입금계좌 표기</div>'
							+'<div class="input">'
								+'<input type="text" id="mnrc_smr_cntn" title="출금계좌 표기 10자 이내 입력" placeholder="10자 이내 입력" data-jx-chk="true" data-jx-chk-opt=\'{"name":"받는통장표시","nullable":false,"maxLength":10}\' />'
								+'<button type="button" class="del">텍스트삭제</button>'
							+'</div>'
			...
			var fndsCodeListPopupHtml = ""
				+ '<div id="fndsCodeList_layer" class="bottom_popup_wrap">'
					+ '<div class="bottom_popup">'
						+ '<div class="bottom_popup_header">'
			...
			//자금코드
			optionAreaHtml.find("#fndsCodeSel").off().on('click', function(evt) {
		...
		drawRegistInfoHtml : function($jq) {
			 ...
			 */
			var registInfoHtml = ""
				+ '<div class="bottom_popup_wrap" id="registInfo">'
					+ '<div class="bottom_popup">'
						+ '<div class="bottom_popup_header">'
						...
						+ '</div>'
						+ '<div class="bottom_popup_body">'
							+ '<ul class="space_list_ty1"  id="'+ this.formIds.rgstInfoListTbl + '" data-jx-list="'+ this.formIds.rgstInfoListTbl + '" >'
								+ '<li '
								+ 'data-jx-execute="click" '
								+ 'data-jx-setter="" '
								+ 'data-jx-setter-source="this" '
								...
								+ '>'
									+ '<div class="card_item_wrap ty2">'
										+ '<div class="card_chkbox">'
											...
											+ '<label for="" aria-labelledby="list_*LI_ROW_INDEX*" onclick="uf_radioCk(this)"></label>'
										+ '</div>'
										+ '<div class="card_item" id="list_*LI_ROW_INDEX*">'
								...
								+ '<li class="item" id="EMPTY">'
									+ '<div class="no_result_msg">'
										+ '<div class="msg">급여이체 등록건이 없습니다.</div>'
									+ '</div>'
								+ '</li>'	
						+ '</ul>'
					+ '</div>'
			...
			var faxSendHtml = ""
				+ '<div id="faxSendInfo" class="bottom_popup_wrap">'
					+ '<div class="bottom_popup">'
						...
						+ '</div>'
						+ '<div class="bottom_popup_body">'
						+ '<div class="title_text ty1">팩스정보</div>'
							+ '<div class="form_group">'
		...
		if(fnt_trn_010101_9_gubn == "fnt_trn_080101_1"){ //자주쓰는이체 편집 [fnt_trn_080101_1.html]
			...
			$("#" + window._tranForm.formIds.favTrnListTbl).find(".ico_box").each(function(i, val) {
				...
				if(!MobUtil.isEmpty(uf_getTrnBankName(bankCd))){
			        ...
			        $(this).addClass("ico_box ty1 ico_bank_000 ico_bank_"+bankCd);
			    } 
			...
			if(null == _this.favtrn_list || undefined == _this.favtrn_list){
				...
				$("#list_080101").find(".ico_box").each(function(i, val) {
					...
					if(!MobUtil.isEmpty(uf_getTrnBankName(bankCd))){
				        ...
				        $(this).addClass("ico_box ty1 ico_bank_000 ico_bank_"+bankCd + " top");
				    } 
...
function uf_setter_favTrnListTbl($jq, data) {
	...
	if((("fnt_trn_110101_1" == window._tranForm.drotAcntViewType) && ($('#step1 #EBNK_CD').val() == "" || isEmpty($('#step1 #EBNK_CD').val()))) ||
			(("fnt_trn_210101_1" == _this.trnformUseSvcId) && (_this.payAcntList.length == 0))) {
		MobPopup.showAlertPopup("출금계좌를 선택해주세요");
	}
	else {
		//사용자지정입금계좌' 정보 일치여부. 및 입금계좌지정등록' 하지않은경우도 계속 거래할수있게 return true.
		var bool = uf_user_mract_dsgt_check(data["MNRC_ACN"]);
		if (bool) {
			var boolPayAcnt = false; //출금권한 체크
			if(undefined != _this.payAcntList && _this.payAcntList.length > 0) {
				if(undefined != data["EBNK_DROT_ACN"] && "" != $.trim(data["EBNK_DROT_ACN"])){ 
					for(var i=0; i<_this.payAcntList.length; i++){
						if($.trim(data["EBNK_DROT_ACN"]) == $.trim(_this.payAcntList[i]["EBNK_ACN"])) {
							boolPayAcnt = true;
						}
					}
				}
			...
			if(boolPayAcnt) {
				...
				if("fnt_trn_110101_1" == window._tranForm.drotAcntViewType) {
					...
					$("#step1 #EBNK_NM").text(uf_getTrnShrgBankName("003"));
					$("#step2 #EBNK_NM").text(uf_getTrnBankName("003"));
					$('#step1 #drot_bncd_logo').removeClass("class");
					$('#step1 #drot_bncd_logo').attr("class", "ico_box ty5 ico_bank_003");
					
					$('#step2 #drot_bncd_logo').removeClass("class");
					$('#step2 #drot_bncd_logo').attr("class", "ico_box ty1 ico_bank_003");
					if(undefined != _this.payAcntList && _this.payAcntList.length > 0) {
						if(undefined != data["EBNK_DROT_ACN"] && "" != $.trim(data["EBNK_DROT_ACN"])){ 
							for(var i=0; i<_this.payAcntList.length; i++){
								if($.trim(data["EBNK_DROT_ACN"]) == $.trim(_this.payAcntList[i]["EBNK_ACN"])) {
									$("#step1 #ACNT_NM").text(_this.payAcntList[i]["ACNT_NM"]);
									$("#step2 #ACNT_NM").text(_this.payAcntList[i]["ACNT_NM"]);
									break;
								}
							}
						}
					}
					$("#step1 #EBNK_ACN").text(formatter.account($.trim(data["EBNK_DROT_ACN"])));
					$("#step2 #EBNK_ACN").text(formatter.account($.trim(data["EBNK_DROT_ACN"])));
				...
				MobPopup.showAlertPopup("선택하신 출금계좌에 대한 출금권한이 없습니다.", "", function() { }, "");
			}
		} 
		else {
...
function acntListSetter($jq, data) {
	...
	$("#drot_acnt_pwd").val("");
	if("fnt_trn_030101_1" == window._tranForm.drotAcntViewType){
		if(data["INDV_YN"] == "Y") {
			$('#step2').find("#indv_ico").text("개인").attr("class", "badge ty3 colorB5").show();
		}
		else if(data["INDV_YN"] == "N") {
			$('#step2').find("#indv_ico").text("기업").attr("class", "badge ty3 colorETC11").show();
		}
		else {
			$('#step2').find("#indv_ico").text("").attr("class", "badge ty3").hide();
		}
	} else {
		if(data["INDV_YN"] == "Y") {
			$('#step1').find("#indv_ico").text("개인").attr("class", "badge ty3 colorB5").show();
		}
		else if(data["INDV_YN"] == "N") {
			$('#step1').find("#indv_ico").text("기업").attr("class", "badge ty3 colorETC11").show();
		}
		else {
			$('#step1').find("#indv_ico").text("").attr("class", "badge ty3").hide();
		}
	}
...
function p_acntListSetter($jq, data) {
	...
	if(data["INDV_YN"] == "Y") {
		$('#step1').find("#indv_ico").text("개인").attr("class", "badge ty3 colorB5").show();
		$('#step2').find("#indv_ico").text("개인").attr("class", "state ty1").show();
	}
	else if(data["INDV_YN"] == "N") {
		$('#step1').find("#indv_ico").text("기업").attr("class", "badge ty3 colorETC11").show();
		$('#step2').find("#indv_ico").text("기업").attr("class", "state ty2").show();
	}
	else {
		$('#step1').find("#indv_ico").text("").attr("class", "badge ty3").hide();
		$('#step2').find("#indv_ico").text("").attr("class", "state").hide();
	}
	...
	$('#step2 #EBNK_CD').val("003"); 
	$('#step1 #EBNK_NM').text(uf_getTrnShrgBankName("003"));  //은행명
	$('#step2 #EBNK_NM').text(uf_getTrnBankName("003")); 
...
function p_openAcntListSetter($jq, data) {
	...
	$('#step1 #drot_bncd_logo').removeClass("class");
	$('#step1 #drot_bncd_logo').attr("class", "ico_box ty5 ico_bank_000 ico_bank_"+data["OPBN_BNCD"]);
	//$('#step1 #drot_bncd_logo').find(".ico_box ty5 ico_bank_").removeClass("class");
	//$('#step1 #drot_bncd_logo').attr("class", "ico_box ty5 ico_bank_000");
	
	$('#step2 #drot_bncd_logo').removeClass("class");
	$('#step2 #drot_bncd_logo').attr("class", "ico_box ty1 ico_bank_000 ico_bank_"+data["OPBN_BNCD"]);
	...
	uf_out : function($jq, data, index) {
		if (data["_is_error"] == "true") {
			if("code_btn_trn0000" == $jq.attr("data-jx-svc-gubn")) { // 출금가능금액 [초기 진입시]
				...
				$("#step1").find("#pvamt_for").text("-"); //"조회오류"
				$("#step2").find("#pvamt_for").text("-"); //"조회오류"
				$(this).find("#won").hide();
		...
		for (var i = 0; i < mnrcBankList.length; i++) {
			...
			if (bank['bank_cd'].startsWith('0')) { // [은행]인경우
				bankList1html += '<li role="option" tabindex="-1" onclick="selectBank(\''
									...
									+ '<div class="ico_box ty1 ico_bank_000 ico_bank_'+ bank["bank_cd"]+'"></div>'
		...
		for (var i = 0; i < opn_bank_list.length; i++) {
			...
			if (bank['bank_cd'].startsWith('0')) { // [은행]인경우
				openBankList1html += '<li role="option" tabindex="-1" onclick="openSelectBank(\''
									...
									+ '<div class="ico_box ty1 ico_bank_000 ico_bank_'+ bank["OPBN_BNCD"]+'"></div>'
	...
	uf_out : function($jq, data, index) {
		...
		if (!(data["list"] == null || data["list"] == undefined || data["list"] == "" || JSON.stringify(data["list"]) == [])) {
			...
			for(var i=0; i<_this.payAcntList.length; i++){                //출금계좌
				if($.trim(list[0]["EBNK_DROT_ACN"]) == $.trim(_this.payAcntList[i]["EBNK_ACN"])) {
					...
					indv_ico_nm = $.trim(_this.payAcntList[i]["INDV_YN"]);
					isRun = true;
		...
		if(isRun) { //“최근출금계좌” 자동 세팅
			if((undefined == _this.q_acno || "" == _this.q_acno) && (undefined == _this.drot_acn || "" == _this.drot_acn)){
				...
				$('#step1 #drot_bncd_logo').removeClass("class");
				$('#step1 #drot_bncd_logo').attr("class", "ico_box ty5 ico_bank_003");
				$('#step1 #EBNK_NM').text("기업");
				if("fnt_trn_110101_1" == window._tranForm.drotAcntViewType){
					if(indv_ico_nm == "Y") {
						$("#step1").find("#indv_ico").text("개인").attr("class", "badge ty3 colorB5").show();
						$('#step2').find("#indv_ico").text("개인").attr("class", "state ty1").show();
					}
					else if(indv_ico_nm == "N") {
						$("#step1").find("#indv_ico").text("기업").attr("class", "badge ty3 colorETC11").show();
						$('#step2').find("#indv_ico").text("기업").attr("class", "state ty2").show();
					}
					else {
			...
			if((undefined == _this.q_acno || "" == _this.q_acno) && (undefined == _this.drot_acn || "" == _this.drot_acn)){
				...
				if("fnt_trn_110101_1" == window._tranForm.drotAcntViewType){
					if(_this.payAcntList[0]["INDV_YN"] == "Y") {
						$("#step1").find("#indv_ico").text("개인").attr("class", "badge ty3 colorB5").show();
						$('#step2').find("#indv_ico").text("개인").attr("class", "state ty1").show();
					}
					else if(_this.payAcntList[0]["INDV_YN"] == "N") {
						$("#step1").find("#indv_ico").text("기업").attr("class", "badge ty3 colorETC11").show();
						$('#step2').find("#indv_ico").text("기업").attr("class", "state ty2").show();
					}
					else {
					...
					jex.setAll($("#step2").find("#drotAcntInfo"), _this.payAcntList[0]);
					if(_this.payAcntList[0]["INDV_YN"] == "Y") {
						$("#step2").find("#indv_ico").text("개인").attr("class", "badge ty3 colorB5").show();
					}
					else if(_this.payAcntList[0]["INDV_YN"] == "N") {
	...
	uf_exec : function() {
		...
		$("#latelyAcntListTbl").find("li").each(function(idx, item){
			...
			if(!MobUtil.isEmpty(uf_getTrnBankName(bankCd))){
		        ...
		        $(target).addClass("ico_box ty3 ico_bank_000 ico_bank_"+bankCd);
		    } 
		});
...
function uf_setter_latelyAcntListTbl($jq, data) {
	...
	if("fnt_trn_110101_1" == _this.trnformUseSvcId) {
		...
		$("#step1 #mnrc_acno").val(dat["mnrc_acno"]);
		$("#step1 #bank_cd").val(dat["bank_cd"  ]);
		$("#step1 #bank_nm").text(dat["bank_nm"  ]);
		
		$("#step2 #mnrc_acno").text(dat["mnrc_acno"]);
		$("#step2 #bank_cd").val(dat["bank_cd"  ]);
		$("#step2 #bank_nm").text(dat["bank_nm"  ]);
		
		$("#step2 #EBNK_CD").val($("#step1 #EBNK_CD").val());
		if($('#step1 #EBNK_CD').val() == "003") {
			$("#s2_drot_area_info #EBNK_NM").text(uf_getTrnBankName($("#step1 #EBNK_CD").val()));
		} else {
			$("#s2_drot_area_info #EBNK_NM").text($("#step1 #EBNK_NM").text());
		}
		$("#step2 #EBNK_ACN").text($("#step1 #EBNK_ACN").text());
		$("#step2 #ACNT_NM").text($("#step1 #ACNT_NM").text());
		
		$('#transfer_reser').hide();
		$('#step2_next1').show();
		$('#step2_next2').hide();
		
		uf_preSelectInq(); 				//계좌이체에서 예금주명조회후 다음스텝으로 이동한다 
	}
			...
			if(undefined != _this.cusInfo && "Y" == _this.cusInfo["USER_MRACT_DSGT_YN"] && _this.isUserMractDsgt_svcAblPage && fnt_trn_090101_1_type == "init"){
				...
				if (!(list == null || list == undefined || list == "" || JSON.stringify(list) == [])) {
					...
					if("" == htmlDat){ //리스트는 있지만 계좌가 빈값이 내려올 경우.
						...
						$("#favAcntStep").find("#no_search_data").hide();
		...
		if(undefined != _this.cusInfo && "Y" == _this.cusInfo["USER_MRACT_DSGT_YN"] && _this.isUserMractDsgt_svcAblPage && fnt_trn_090101_1_type == "init"){
			...
			$("#favAcntListTbl").find("li").each(function(idx, item){
			    ...
			    if(!MobUtil.isEmpty(uf_getTrnBankName(bankCd))){
			        ...
			        $(target).addClass("ico_box ty1 ico_bank_000 ico_bank_"+bankCd);
			    } 
			});
...
var fnt_trn_030101_1 = {
	...
	uf_exec : function() {
        ...
        //$.nativeCall("moveWebFocus");
		
		//setTimeout(function() {
		//	comLayerPopUtil.open('registInfo');
//			window.location.hash="imsiFocus";
		//}, 500);
		
		comLayerPopUtil.open('registInfo');
		//$("#registInfo").attr("tabindex", "0").focus();
		//$('#registInfo').show();
		//uf_goStep(4007);
	}
};
					...
					htmlDat += "<div class=\"acount_item ty4\" role=\"button\">";
						...
						htmlDat += "<div class=\"item_top\">";
							...
							if(undefined != _this.cusInfo && "Y" == _this.cusInfo["USER_MRACT_DSGT_YN"] && _this.isUserMractDsgt_svcAblPage && "2" == acnt_dcd){
								htmlDat += '<span class="badge ty3 colorETC16">입금지정계좌</span>';
							}
							htmlDat += "<span id='ACNT_NM'>"+ ACNT_NM +"</span></div>";
...
function uf_getTrnConfCardInfo() {
	...
	if(cur_step == 34){ //여러계좌이체 전결에서 사용
		...
		_this.trnConfCardData["txt_bank_nm"  ] = _confirmTranList[0]["MNRC_BANM"]; //입금은행
		...
		_this.trnConfCardData["txt_bank_nm"  ] = _this.tranData["MNRC_BANM"]; //입금은행
 ...
 * 단, 결재함업무' step31에서는 사용못함. :: 결재함인 경우 초기화 하지않음(_this.mnrcBankList).약어명사용
 */
...
/**
 * 은행명 반환. :: param(bank_cd)
 * _this.mnrcBankShrgNmList:단축은행명 사용
 */
function uf_getTrnShrgBankName(bank_cd) { 
	var bank_nm = "";
	for (var i = 0; i < _this.mnrcBankShrgNmList.length; i++) {
		if($.trim(bank_cd) == _this.mnrcBankShrgNmList[i]["bank_cd"]) {
			bank_nm = _this.mnrcBankShrgNmList[i]["bank_nm"];
			break;
		}
	}
	return bank_nm;
...
/**
 * (펀드) 1등급 도달 펀드의 적정성 평가 프로세스 신설 요청 [M20240919-A13 (R20240912-A60)]
 *   UIB_FND_SC5540_000201  IISIIZG01080000  UIBO00083826  SCIB 1등급 터치 펀드 추가매입 적정여부 조회
 *   UIB_FND_SC5540_000204  CBKEBKI00132800  UIBO00077214  계좌소유주일치여부검증
 */
var trnform_fnc_fnm_010301_0 = {
	mnrc_acn : "",
	callback : undefined,
	txt_noti : "",
	cbMenuId : "",
	resData  : {},
	uf_run : function(mnrc_acn, callback, txt_noti) {
		this.resData = {};
		this.mnrc_acn = mnrc_acn;
		this.callback = callback;
		this.txt_noti = undefined == txt_noti ? "추가납입" : txt_noti;
		//	"추가납입"         (Default)
		//	"자동이체 등록"
		//	"자동이체 변경"
		
		jex.setJexObj($("#trnform_fnc_fnm_010301_0").attr("data-jx-svc-onload", "true"));
	}
	, uf_in : function($jq, sourceData) {
		var jsonDat  = {};
		jsonDat["ACN"] = this.mnrc_acn; // 계좌번호
		//CHCP_PROP_YN                  // 점검적정여부
		return jsonDat;
	},
	uf_out : function($jq, data, index) {
		// CHCP_PROP_YN    점검적정여부
		//    1:적정
		//    2:부적정(투자성향분석 및 적정여부 검증 등록 가능)
		//    3:부적정(당일 등록분으로 익일 이후 등록 가능)
		//    4:계좌소유주 불 일치  (임의 코드셋팅)  <<--::(계좌소유주일치여부검증)
		this.resData = data;
		
		var msg = "";
		
		if (data.CHCP_PROP_YN == "1") {     // 1:적정 => 거래 허용
			this.callback(data);
		}
		else if(data.CHCP_PROP_YN == "2") { // 2:부적정
			var _baseURI = document.baseURI.split("/");
			var callbackId = _baseURI[_baseURI.length-1].split(".html");
			this.cbMenuId = callbackId[0];
			
			msg = "본 펀드는 <span class='txt point_red'>위험등급이 1등급으로 상향</span>되어 "+this.txt_noti+" 시 투자성향분석을 통한 적정 여부 검증이 필요합니다.<br>적정 여부 검증을 진행하시겠습니까?";
			//주메세지, title, [확인], [취소], 서브메세지
			MobPopup.showConfirmPopup(msg, "알림" , function() {
				//확인
				var params = "CUS_ACN=" + trnform_fnc_fnm_010301_0.mnrc_acn +"&CB_MENUID=" + trnform_fnc_fnm_010301_0.cbMenuId;
				params += "&lncd=" + trnform_fnc_fnm_010301_0.resData["PDLN_CD"]; //상품라인코드
				params += "&grcd=" + trnform_fnc_fnm_010301_0.resData["PDGR_CD"]; //상품그룹코드
				params += "&tmcd=" + trnform_fnc_fnm_010301_0.resData["PDTM_CD"]; //상품템플릿코드
				params += "&pdcd=" + trnform_fnc_fnm_010301_0.resData["PDCD"   ]; //상품코드
				comWebkey_goMenu("5010", "fnc_fnm_010301_1", params);
			}, function() {
				//취소
			}, "");
		}
		else if(data.CHCP_PROP_YN == "3") { // 3:부적정
			msg = "검증 결과가 <span class='txt point_red'>부적정</span>하여 "+this.txt_noti+"이 불가합니다.<br>적정 여부 검증은 1일 1회로 제한되며, "+this.txt_noti+"을 원하시는 경우 익일에 재거래해주시기 바랍니다.";
			//주메세지, title, callback[확인], 서브메세지
			MobPopup.showAlertPopup(msg, '알림', function() { });
		}
		//계좌소유주일치여부검증
		else if(data.CHCP_PROP_YN == "4") { // 4:계좌소유주 불 일치  (임의 코드셋팅)
			if("자동이체 등록" == this.txt_noti) {
				msg = "해당 계좌로의 자동이체 등록이 불가합니다. (사유 : 펀드 적정여부 미검증)";
			} else if("자동이체 변경" == this.txt_noti) {
				msg = "해당 자동이체는 변경이 불가합니다. (사유 : 펀드 적정여부 미검증)";
			} else { //Default
				msg = "해당 계좌로의 입금이 불가합니다. (사유 : 펀드 적정여부 미검증)";
			}
			//주메세지, title, callback[확인], 서브메세지
			MobPopup.showAlertPopup(msg, '알림', function() { });
		}
