 ...
 * data-chart-tooltip='tooltipName'		// tooltip 스타일 을 정의
 **/
(function() {
	...
	var colorSet	= {
		...
		,"rvsDflt" 	:  [ "#8cbdfa" ,"#acadf0" ,"#69dcdf" ,"#fca66d" ,"#fddc68", "#676767"  ]
		,"onlyblue"  :  [ "#5db1fa", "#5db1fa" ,"#5db1fa" ,"#5db1fa" ,"#5db1fa" ,"#5db1fa" ]
		,"mgl" 		:  [ "#67dddd", "#67dddd", "#67dddd", "#67dddd", "#67dddd", "#67dddd","#67dddd", "#67dddd", "#67dddd", "#67dddd" ] //myGradeLine
		,"purple" 	:  [ "#797ae6", "#68dcde" ,"#abacf0", "#676767", "#8cbdfa", "#fddc68" ] //Radar
	   ,"yellow" 	:  [ "#fedf73", "#fba66d" ,"#676767"]  
	   ,"white" 	:  [ "#ffffff", "#fec20a"] 
	   ,"test2" 	:  [ "#008000" ,"#68dcde" ,"#abacf0", "#676767", "#8cbdfa", "#fddc68"  ]
	   ,"bgradation" :  [ "#ffffff", "#a6d4ee", "#0ab2e3", "#3399d7"  ] //"rgba(255,255,255,1)","rgba(255,255,255,0.7)","rgba(255,255,255,0.4)","rgba(255,255,255,0.1)"
	   ,"berrycoral" :  [ "#8cbdfa", "#fca66d","#8cbdfa", "#fca66d","#8cbdfa", "#fca66d","#8cbdfa", "#fca66d","#8cbdfa", "#fca66d",]  
  }
	...
	var chartopt	= {
			dflt : function() {
				return {
						...
						,tooltips:	{ mode: 'index', displayColors:false, intersect: false, enabled:false } // enable : true로 바꾸면 활성화..  displayColors:false 툴팁 라벨 끄기
				...
				var ret = chartopt.dflt();
				ret.elements							= { line : { tension : 0.5} };
				ret.scales.xAxes[0]['gridLines'] 		= {'display':true,'drawBorder':false};
				ret.scales.yAxes[0]['gridLines'] 		= {'display':false,'drawBorder':false};
				ret.scales.yAxes[0]['ticks']['callback']= function(label, index, labels) { return ""}; 
				ret.scales.yAxes[0]['ticks']['callback']= function(label, index, labels) { return ""};
				ret.layout								= {};
				...
				ret.layout.padding.bottom				= 0;
				return ret;
			},whiteThinBar : function() {
				var ret = chartopt.dflt();
				ret.elements={};
				ret.responsive							= true;
				ret.maintainAspectRatio					= true;
				ret.scales.xAxes[0]['gridLines'] 		= {'display':false,'drawBorder':false};
				ret.scales.xAxes[0]['ticks']			= {'fontColor':"#ffffff"}
				ret.scales.yAxes[0]['ticks']			= {'fontColor':"#ffffff"}
				ret.scales.yAxes[0]['gridLines'] 		= {'display':false,'drawBorder':false};
				ret.scales.xAxes[0]['barPercentage'] 	= 0.5;
				ret.scales.yAxes[0].ticks.beginAtZero 	= true;
				// ret.scales.yAxes[0].ticks.stepSize = 0;
				ret.scales.yAxes[0]['ticks']['callback']= function(label, index, labels) {  return "" };
				ret.scales.xAxes[0]['ticks']['autoSkip']= false; 
				...
				return {
					...
					scale:	{
						ticks: {	callback:	function(label, index, labels) { return ""; }
								,	beginAtZero: false  , min : 0, max : 100,  stepSize : 50 , fontSize : 14}
						,pointLabels : { fontSize : 14 , fontColor : "#aaaaaa"}	
						,gridLines :  { color : "#ebebeb", lineWidth : 1 }
						,angleLines : { color : "#ebebeb", lineWidth : 1 } 
					}
					,tooltips   : { displayColors:false, enabled:true}
					// ,events : { "touchstart" : false, "click" : false, "touchend" : false, "mousemove" : false, "touchmove" : false }
				};
			},legendr : function(){
				var ret = chartopt.dflt();
				ret.scales.xAxes[0]['gridLines'] 		= {'display':false,'drawBorder':false};
